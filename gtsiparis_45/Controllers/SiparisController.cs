...
namespace gtsiparis_45.Controllers
{
    public class SiparisController : Controller
    {
        ...
        {
            ViewBag.Kullanici_Id = new SelectList(db.Kullanici, "Id", "Adi");
            ViewBag.Urun_Id = new SelectList(db.Urun, "Id", "Adi");
            ViewBag.OnayliKullanici_ID = new SelectList(db.Kullanici, "Id", "Adi");
        ...
        public ActionResult Create([Bind(Include = "Id,Miktar,Tarih,Onay,Iade,Kullanici_Id,Urun_Id,OnayKullaniciId")] Siparis siparis)
        {
            ...
            ViewBag.OnayliKullanici_ID = new SelectList(db.Kullanici, "Id", "Adi", siparis.OnayKullaniciId);
            ViewBag.Kullanici_Id = new SelectList(db.Kullanici, "Id", "Adi", siparis.Kullanici_Id);
